...
[![Deploy to Cloudflare](https://deploy-to-workers-staging.r.workers.dev/button)](https://deploy-to-workers-staging.r.workers.dev/?url=https://github.com/nevikashah/openauth-template)
